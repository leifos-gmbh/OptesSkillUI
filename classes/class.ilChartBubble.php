 ...
 * @ingroup
 */
class ilChartBubble extends ilOptesChart
{
	...
	protected function addCustomJS()
	{
		...
		$pd = $this->getPluginObject()->getDirectory();
		$tpl->addJavascript($pd."/js/flot/jquery.flot.JUMlib.js");
		$tpl->addJavascript($pd."/js/flot/jquery.flot.bubbles.ilias.js");
	}

	/**
	 * Set plugin object
	 *
	 * @param ilPlugin $a_val plugin object	
	 */
	function setPluginObject($a_val)
	{
	...
	public function getHTML()
	{
		...
		$chart = $this->getPluginObject()->getTemplate("tpl.grid2.html");
